...
const Credits = () => {
    return (
        <Box>
            ...
            <Box maxW='652px' w='100%' border='1px solid #8AABED' p='30px' mb='40px' boxShadow='0px 5px 0px #215ED7' position='relative' textTransform='uppercase' display='flex' alignItems='center' justifyContent='space-between'>
                <Box>
                    <Text fontSize='24px'>My Credits</Text>
                    <Text fontSize='44px'>50000</Text>
                </Box>
                <Button fontSize='20px' fontWeight='normal' color='white' bg='#215ED7' border='2px solid white' borderRadius='50px' mr='30px' p='14px 23px' _hover={{ color: 'black', bg: 'white', border: '2px solid #215ED7' }} >
                    Redeem
                </Button>
            </Box>
            ...
            <Box w='100%' border='1px solid #8AABED' p='30px'>
