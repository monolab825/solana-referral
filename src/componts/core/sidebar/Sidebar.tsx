        ...
        <>
            ...
            {pathname === '/packages' ? <Link href='/packages'>
                <Box
                    ...
                    pl='40px'
                    py='20px'
                    bg={pathname === '/packages' ? '#215ED7' : 'transparent'}
                    cursor='pointer'
                    gap='25px'
                    mb={pathname === '/packages' ? '7px' : '10px'}
                    boxShadow={pathname === '/packages' ? '0px 5px 0px #09368F' : 'none'}
                    color={pathname === '/packages' ? 'white' : 'black'}
                >
                    <Text fontSize='32px'>
                        <TbPackages />
                    </Text>
                ...
                <Link href='/packages'>
                    <Box
                        ...
                        pl='40px'
                        py='20px'
                        bg={pathname === '/packages/details' ? '#215ED7' : 'transparent'}
                        cursor='pointer'
                        gap='25px'
                        mb={pathname === '/packages/details' ? '7px' : '10px'}
                        boxShadow={pathname === '/packages/details' ? '0px 5px 0px #09368F' : 'none'}
                        color={pathname === '/packages/details' ? 'white' : 'black'}
                    >
                        <Text fontSize='32px'>
                            <TbPackages />
                        </Text>
